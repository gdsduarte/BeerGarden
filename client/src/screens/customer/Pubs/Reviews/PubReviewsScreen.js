/**
 * This screen displays the reviews for a pub.
 * It allows users to view and write reviews for the pub.
 * It also calculates the average rating for the pub based on all reviews.
